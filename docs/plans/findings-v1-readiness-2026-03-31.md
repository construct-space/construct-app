...
> **Status (2026-04-20):** Partial. Many findings landed (widget sandbox,
> Morpheus gap fixes, verification system). Needs a fresh re-triage pass:
> walk each finding, mark Done / Still Open / Superseded, and either close
> the doc or spin out the still-open ones into their own focused plans.
