...
<template>
  <div :class="[
    ...
    <!-- Header -->
    <div class="flex items-center gap-3 px-4 py-3 border-b border-[var(--app-border)]/30 shrink-0"
      :class="standalone && 'select-none'" :data-tauri-drag-region="standalone || undefined">
    ...
    <AgentInput ref="inputRef" :disabled="!operator.connected.value" placeholder="Ask anything..." @send="handleSend" />
  </div>
</template>
