...
// Brain doesn't need explicit project context — skills + per-prompt
// metadata carry it. setProject/clearProject become no-ops until a brain
// equivalent (if any) is wired.
const setProject = async (_ctx: unknown): Promise<void> => { /* brain: no-op */ }
const clearProject = async (): Promise<void> => { /* brain: no-op */ }
