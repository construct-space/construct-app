  ...
  <div class="min-h-screen bg-[var(--app-background)] flex items-center justify-center px-6">
    <div class="w-full max-w-sm text-center">
      ...
      <div v-if="error" class="space-y-4">
        <p class="text-2xl">
          <span class="text-[var(--app-muted)]">AUTH:</span><span class="font-bold text-[var(--app-foreground)]">FAILED</span>
        </p>
      ...
      <div v-else class="space-y-4">
        <p class="text-2xl">
          <span class="text-[var(--app-muted)]">AUTH:</span><span class="font-bold text-[var(--app-foreground)]">CONNECTING</span>
        </p>
        <p class="text-sm text-[var(--app-muted)]">{{ status }}</p>
