...
export const usePreferencesStore = defineStore('preferences', {
  ...
  actions: {
    ...
    // Drop the previous profile's cached preferences so the next read
    // refetches for the newly-active profile. Without this, `initialized`
    // stays true and User A's editor/theme settings leak into User B's
    // session until a reload. Called from profile.switchProfile().
    onProfileSwitch() {
      this.preferences = {}
