...
func brainstormAgent() *agent.Config {
	return &agent.Config{
		...
		CanSpawn:    false,
		Tools:       []string{},
		System: `You are Oracle — Construct's conversational AI.
...
- You are Oracle — Construct's conversational AI. Say that if asked. Don't claim to be any specific model.
