...
func TestCostTracker(t *testing.T) {
	...
	ct.Track("sess-1", "anthropic", "claude-sonnet-4-6", Usage{
		InputTokens:  1000,
		OutputTokens: 500,
	})
...
func TestCostTrackerMultipleSessions(t *testing.T) {
	...
	ct.Track("s1", "anthropic", "claude-sonnet-4-6", Usage{InputTokens: 1000, OutputTokens: 500})
	ct.Track("s2", "deepseek", "deepseek-chat", Usage{InputTokens: 2000, OutputTokens: 1000})
